...
// `define SDFFILE    "transformer_syn.sdf"  // No synthesis file available, temporarily commented out
`define End_CYCLE  50000000 

// Updated paths for personal record (assuming patterns are in the same directory)
`define PAT_EXK       "./K.txt"
`define PAT_EXQ       "./Q.txt"
`define PAT_EXV       "./V.txt"
`define L0_EXP0       "./QK0.txt"
`define L0_EXP1       "./QK1.txt"
`define L0_EXP2       "./QK2.txt"
`define L1_EXP0       "./QKV.txt"

`define L0_SOFT0      "./soft0.txt"
`define L0_SOFT1      "./soft1.txt"
`define L0_SOFT2      "./soft2.txt"
